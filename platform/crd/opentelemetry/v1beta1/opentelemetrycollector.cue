...
#OpenTelemetryCollector: {
	...
	spec?: {
		...
		autoscaler?: {
			...
			minReplicas?:             int32 & int & >=1
			targetCPUUtilization?:    int32 & int & >=1
			targetMemoryUtilization?: int32 & int & >=1
		}
		config!: {
			connectors?: {
				...
		...
		livenessProbe?: {
			failureThreshold?:              int32 & int & >=1
			initialDelaySeconds?:           int32 & int & >=0
			periodSeconds?:                 int32 & int & >=1
			successThreshold?:              int32 & int & >=1
			terminationGracePeriodSeconds?: int64 & int & >=1
			timeoutSeconds?:                int32 & int & >=1
		}
